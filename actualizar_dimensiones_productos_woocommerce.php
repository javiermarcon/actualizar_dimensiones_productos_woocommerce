...
require_once __DIR__ . '/includes/class-adpw-category-update-start-service.php';
...
require_once __DIR__ . '/includes/class-adpw-excel-import-temp-store.php';
require_once __DIR__ . '/includes/class-adpw-excel-parse-sheet-batch-service.php';
require_once __DIR__ . '/includes/class-adpw-excel-save-category-meta-batch-service.php';
require_once __DIR__ . '/includes/class-adpw-excel-update-products-batch-service.php';
